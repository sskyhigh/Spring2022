 ...
 * @Author Shao Yan
 * @Since 7/24/2022
 * @Description: This program calculates distance and velocity, prompts user to enter a time (measured
 * in seconds). The program starts offs with having the user to enter a time(measured in seconds).
 * The program then prints out the result on the screen displaying both the distance and velocity.
 * Each calculation, i.e, distance and velocity are placed in their own methods. At the end of the
 * program, the program outputs the answers to a text file.
 * Data was also appended. I spent my class time doing this assignment, there shouldn't be any errors.
